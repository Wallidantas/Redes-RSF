        ...
        if(self._linkLayer._readedPackages != []):
            ...
            if(header._request == -1):
                ...
                if(header._macDestiny == self._linkLayer._phyLayer._id):
                    print("ID", self._linkLayer._phyLayer._id, ": Chegada de pacote de dados: ", package._data)
                else:
                    print("ID", self._linkLayer._phyLayer._id, ": Chegada de pacote de dados, porém não sou o destino")
            ...
            #Se o pacote for recebido for um RREQ
                ...
                if(not header._sequenceNumber in self._listRREQs):
                    ...
                    print("ID", self._linkLayer._phyLayer._id, ": Já possuo esse RREQ: ", header._sequenceNumber)
